...
public class TwoBallPlusDefenseAuto  extends SequentialCommandGroup {
    ...
    public TwoBallPlusDefenseAuto(DriveSubsystem driveTrain, Launcher launcher, BallTower ballTower, Intake intake, Conveyor conveyor, LimeLight limelight) {
    ...
    redShoot_trajectory = TrajectoryGenerator.generateTrajectory(
        ...
        List.of(
            new Translation2d(Units.inchesToMeters(-30.25), Units.inchesToMeters(0))
        ), 
        new Pose2d(Units.inchesToMeters(-20), Units.inchesToMeters(0), new Rotation2d(Units.degreesToRadians(0))), trajectoryConfig);
