...
topRoller.setInverted(true);
 ...
 kD = 0.0008;//0.0004; 
 kIz = 0; 
 kFF = 0.00017;//0.00019; // increased from 0.00018 to see if ramps to speed more quickly and stays at it  
 kMaxOutput = 1; 
 kMinOutput = -1;
 maxRPM = 5700;
...
kDtop = 0.0;//0.0004; 
kIztop = 0; 
kFFtop = 0.00018;//0.00019 // increased from 0.00018 to see if ramps to speed more quickly and stays at it  
kMaxOutputTop = 1; 
kMinOutputTop = -1;
maxRPMtop = 5700;
